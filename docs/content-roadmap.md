...
P1 and P2 are complete, and **Ice Mine P3.1–P3.4** are delivered. Continue in roadmap order with **P3.5 — Collapse/fracture effects**, then P3.6 to finish the Ice Mine before starting Solar Yard.
