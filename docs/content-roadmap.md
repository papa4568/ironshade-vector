...
Build **P9-D — Specialization integration** on the verified 93-node Network: add LV15/LV16+ specialization subgraphs plus campaign/boss unlocks and gear/crafting/faction/Singular hooks without weakening the existing routing, save/migration, class-arsenal, Keystone exclusivity, or mobile-readability contracts.
