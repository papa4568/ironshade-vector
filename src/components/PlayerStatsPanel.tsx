...
import { buildIdentity, deriveCombatBuild, gearResonanceForProfile, operatorClassDefinitions, operatorClassForProfile, specializationDefinitions, xpProgress, type PlayerProfile } from '../game/meta';
