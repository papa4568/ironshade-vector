...
function GearComparison({ profile, item }: { profile: PlayerProfile; item: Item }) {
  ...
  return (
    <>
      <div className="gear-quick-read"><small>PRIMARY EFFECT</small><span>{primaryItemEffect(item)}</span></div>
