...
export type ParallaxDebtProgress = { status: 'locked' | 'active' | 'complete'; step: number; completed: string[]; evidence: string[]; lastBeat: string };
