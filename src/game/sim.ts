...
export function triggerAbility(state: SimState, index = 0) {
  ...
  if (index === 0) {
    ...
    else if (target && state.build.operatorClass === 'vanguard') pushEvent(state, `FRACTURE TAG // ${target.label.toUpperCase()} ARMOR PATH OPEN`, 1.35);
