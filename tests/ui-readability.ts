...
assert(androidSmoke.includes('ANDROID_MOBILE_MENU_PASS') && androidSmoke.includes("=== 'operations'") && androidSmoke.includes('primaryCount !== 5'), 'Android smoke is not validating the Tactical Command navigation hierarchy and mobile rail.');
