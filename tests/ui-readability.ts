...
assert(classSelect.includes('signatureName') && classSelect.includes('combatLoop') && classSelect.includes('STARTING RESONANCE'), 'Class intake does not explain signature gameplay loops and starting gear resonance.');
