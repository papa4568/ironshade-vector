...
assert(armory.includes('function RarityText') && armory.includes('rarityDisplayLabel(item.rarity)') && armory.includes('rarityDisplayLabel(rarity)') && !armory.includes('rarityCue(item)'), 'P7-C Build surfaces are not consistently using the shared rarity label.');
