...
assert(classBuildCss.includes('P19-E // Compact-phone management hierarchy') && classBuildCss.includes('--p19-management-secondary: 12px') && classBuildCss.includes('--p19-management-decision: 14px') && classBuildCss.includes('max-height: 560px') && classBuildCss.includes('.protocol-panel .skill-path-grid'), 'P19-E compact-landscape management text floor or Skills reflow is missing.');
