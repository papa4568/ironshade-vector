...
assert(classSelect.includes('/assets/ui/classes/vanguard.svg') && classSelect.includes('/assets/ui/classes/vector.svg') && classSelect.includes('/assets/ui/classes/systems.svg'), 'Class intake is missing lightweight authored crest assets.');
assert(combat.includes('/assets/ui/classes/vanguard.svg') && combat.includes('class-mechanic-hud'), 'Combat HUD is missing the mobile class crest asset mapping.');
assert(classSelectCss.includes('.class-choice-grid') && classSelectCss.includes('.class-selected-panel') && classSelectCss.includes('.class-starting-kit-grid') && classSelectCss.includes('.class-advanced-details') && classSelectCss.includes('.class-mechanic-hud') && classSelectCss.includes('.game-root.class-vanguard') && classSelectCss.includes('.game-root.class-vector') && classSelectCss.includes('.game-root.class-systems') && classSelectCss.includes('max-height: 650px') && classSelectCss.includes('safe-area-inset-left'), 'Class intake/skill-kit/combat feedback styling is missing progressive disclosure, class theming, landscape, or safe-area coverage.');
