...
assert(renderer.includes('weaponHandlingProfiles') && renderer.includes('dataset.weaponHandling') && renderer.includes("handling.reloadStyle === 'chamber-feed'") && renderer.includes("handling.ventStyle === 'coil-quench'") && renderer.includes('handling.recoilVisual') && renderer.includes('weaponHandlingProfiles[state.player.currentWeapon].cameraKick * 0.04'), 'P8-F Three renderer is missing family stance/recoil/reload/vent/muzzle/camera handling.');
assert(combat.includes('weaponHandlingProfiles[p.currentWeapon]') && combat.includes('handling.muzzleLength') && combat.includes('weaponHandlingProfiles[state.player.currentWeapon].cameraKick'), 'P8-F Canvas fallback is missing family muzzle or camera response.');
