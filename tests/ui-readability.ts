...
assert(browserSmoke.includes('BROWSER_SKILL_HIERARCHY_PASS') && browserSmoke.includes('How Skills progression works') && browserSmoke.includes('Choose Standard, a Lens, or a class Evolution for each skill.') && browserSmoke.includes('SHARED LENSES') && browserSmoke.includes('CLASS EVOLUTIONS'), 'Browser E2E does not exercise the P8-H Build skill hierarchy through the P18-F decision-first Skills surface.');
...
assert(androidSmoke.includes('ANDROID_SKILL_HIERARCHY_PASS') && androidSmoke.includes('How Skills progression works') && androidSmoke.includes('Choose Standard, a Lens, or a class Evolution for each skill.') && androidSmoke.includes('SHARED LENSES') && androidSmoke.includes('CLASS EVOLUTIONS'), 'Android smoke does not exercise the P8-H touch skill hierarchy through the P18-F decision-first Skills surface.');
