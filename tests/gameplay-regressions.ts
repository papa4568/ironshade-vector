...
function iceMineBrittleSupportSmoke() {
  ...
  assert.match(timedShear.eventText, /BRITTLE SUPPORTS FAILED|FRACTURE PATH ALREADY CLEARED/, 'Timed support failure needs deterministic lane-opening feedback.');
}
